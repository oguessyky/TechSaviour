...
?>
<script>
    document.body.classList.add('<?php echo $category ?>');
    document.getElementById('categoryTitle').innerHTML = '<?php echo $category ?>';
    document.getElementById('categoryDescription').innerHTML = '<?php
        switch ($category) {
            case "gaming":
                echo "These type of computer have strong processing power to run various task been given";
                break;
            case "business":
                echo "These type of computer have long battery life, that can let them standby the whole day";
                break;
            case "art":
                echo "These type of computer ensure the accuracy of the display quality to syn the color in the real world";
                break;
        }
    ?>';
